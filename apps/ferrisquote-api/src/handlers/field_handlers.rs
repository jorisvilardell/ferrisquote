...
pub async fn add_field<FS: FlowService + StepService + FieldService, ES: EstimatorService, SS: ferrisquote_domain::domain::submission::ports::SubmissionService>(
...
pub async fn update_field_config<FS: FlowService + StepService + FieldService, ES: EstimatorService, SS: ferrisquote_domain::domain::submission::ports::SubmissionService>(
    State(state): State<AppState<FS, ES, SS>>,
...
pub async fn remove_field<FS: FlowService + StepService + FieldService, ES: EstimatorService, SS: ferrisquote_domain::domain::submission::ports::SubmissionService>(
    State(state): State<AppState<FS, ES, SS>>,
    Path(field_id): Path<String>,
...
pub async fn move_field<FS: FlowService + StepService + FieldService, ES: EstimatorService, SS: ferrisquote_domain::domain::submission::ports::SubmissionService>(
    State(state): State<AppState<FS, ES, SS>>,
    Path(field_id): Path<String>,
